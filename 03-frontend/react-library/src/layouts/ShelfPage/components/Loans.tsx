  ...
  useEffect(() => {
    const fetchUserCurrentLoans = async () => {
      if (authState && authState.isAuthenticated) {
        ...
        if (!selfCurrentLoansResponse.ok) {
          throw new Error('Something went wrong!');
        }
        const selfCurrentLoansResponseJson = await selfCurrentLoansResponse.json();
        setShelfCurrentLoans(selfCurrentLoansResponseJson);
      }
